export const dict = {
  ...
  "command.preview.description": "Chạy và kiểm tra ứng dụng React của không gian làm việc",
  ...
  "session.tab.preview": "Xem trước",
  "session.tab.unknown": "Phiên không xác định",
  "session.preview.locatorUnavailable": "Bộ định vị không khả dụng",
  "session.preview.sourceOutsideWorkspace": "Nguồn xem trước nằm ngoài không gian làm việc hiện hoạt",
  "session.preview.inspectorError": "Lỗi trình kiểm tra xem trước",
  "session.preview.inspect": "Kiểm tra",
  "session.preview.reload": "Tải lại",
  "session.preview.logs": "Nhật ký",
  "session.preview.heading": "Xem trước ứng dụng React của bạn",
  "session.preview.starting": "Đang khởi động xem trước...",
  "session.preview.description":
    "Chạy tập lệnh dev của không gian làm việc trên cổng {{port}}. Thêm @opencode-ai/preview/vite vào cấu hình Vite để bật tính năng kiểm tra nguồn.",
  "session.preview.directory": "Thư mục dự án",
  "session.preview.port": "Cổng",
  "session.preview.start": "Bắt đầu xem trước",
  "session.preview.restart": "Khởi động lại xem trước",
  "session.preview.serverUnreachable": "Máy chủ xem trước không thể truy cập tại {{url}}",
  "session.preview.processExited": "Tiến trình xem trước đã thoát với mã {{code}}",
