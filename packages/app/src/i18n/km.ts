export const dict = {
  ...
  "command.preview.description": "ដំណើរការ និងត្រួតពិនិត្យកម្មវិធី React នៃកន្លែងធ្វើការ",
  ...
  "session.tab.preview": "មើលជាមុន",
  "session.tab.unknown": "សម័យមិនស្គាល់",
  "session.preview.locatorUnavailable": "មិនមានឧបករណ៍កំណត់ទីតាំង",
  "session.preview.sourceOutsideWorkspace": "ប្រភពមើលជាមុននៅខាងក្រៅកន្លែងធ្វើការសកម្ម",
  "session.preview.inspectorError": "កំហុសកម្មវិធីត្រួតពិនិត្យមើលជាមុន",
  "session.preview.inspect": "ត្រួតពិនិត្យ",
  "session.preview.reload": "ផ្ទុកឡើងវិញ",
  "session.preview.logs": "កំណត់ហេតុ",
  "session.preview.heading": "មើលកម្មវិធី React របស់អ្នកជាមុន",
  "session.preview.starting": "កំពុងចាប់ផ្តើមការមើលជាមុន...",
  "session.preview.description":
    "ដំណើរការស្គ្រីប dev នៃកន្លែងធ្វើការនៅលើច្រក {{port}}។ បន្ថែម @opencode-ai/preview/vite ទៅការកំណត់ Vite របស់អ្នក ដើម្បីបើកការត្រួតពិនិត្យប្រភព។",
  "session.preview.directory": "ថតគម្រោង",
  "session.preview.port": "ច្រក",
  "session.preview.start": "ចាប់ផ្តើមមើលជាមុន",
  "session.preview.restart": "ចាប់ផ្តើមមើលជាមុនឡើងវិញ",
  "session.preview.serverUnreachable": "ម៉ាស៊ីនមេមើលជាមុនមិនអាចទៅដល់បាននៅ {{url}}",
  "session.preview.processExited": "ដំណើរការមើលជាមុនបានចេញជាមួយលេខកូដ {{code}}",
