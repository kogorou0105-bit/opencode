...
export const dict = {
  ...
  "command.preview.description": "Run and inspect the workspace React app",
  ...
  "session.preview.locatorUnavailable": "Locator unavailable",
  "session.preview.sourceOutsideWorkspace": "Preview source is outside the active workspace",
  "session.preview.inspectorError": "Preview inspector error",
  "session.preview.inspect": "Inspect",
  "session.preview.reload": "Reload",
  "session.preview.logs": "Logs",
  "session.preview.heading": "Preview your React app",
  "session.preview.starting": "Starting preview...",
  "session.preview.description":
    "Runs the workspace dev script on port {{port}}. Add @opencode-ai/preview/vite to your Vite config to enable source inspection.",
  "session.preview.directory": "Project directory",
  "session.preview.port": "Port",
  "session.preview.start": "Start preview",
  "session.preview.restart": "Restart preview",
  "session.preview.serverUnreachable": "Preview server did not become reachable at {{url}}",
  "session.preview.processExited": "Preview process exited with code {{code}}",
