export const dict = {
  ...
  "command.preview.description": "Koyr og kanna workspace React-appina",
  ...
  "session.tab.preview": "Forskóðan",
  "session.tab.unknown": "Ókend seta",
  "session.preview.locatorUnavailable": "Staðsetari ikki tøkur",
  "session.preview.sourceOutsideWorkspace": "Forskóðanarkelda er uttan fyri virkna workspace",
  "session.preview.inspectorError": "Forskóðanarskoðingarfeilur",
  "session.preview.inspect": "Kanna",
  "session.preview.reload": "Endurlesa",
  "session.preview.logs": "Loggar",
  "session.preview.heading": "Forskóða tína React-app",
  "session.preview.starting": "Byrja forskóðan...",
  "session.preview.description":
    "Koyrir workspace dev-skriptið á havn {{port}}. Legg @opencode-ai/preview/vite til tína Vite-uppseting fyri at virkja keldukanning.",
  "session.preview.directory": "Verkætlanarmappa",
  "session.preview.port": "Havn",
  "session.preview.start": "Byrja forskóðan",
  "session.preview.restart": "Endurbyrja forskóðan",
  "session.preview.serverUnreachable": "Forskóðanarambætarin gjørdist ikki atkomiligur á {{url}}",
  "session.preview.processExited": "Forskóðanartilgongdin endaði við kotu {{code}}",
