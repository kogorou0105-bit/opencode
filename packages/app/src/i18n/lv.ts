export const dict = {
  ...
  "command.preview.description": "Palaist un pārbaudīt darbtelpas React lietotni",
  ...
  "session.tab.preview": "Priekšskatījums",
  "session.tab.unknown": "Nezināma sesija",
  "session.preview.locatorUnavailable": "Lokators nav pieejams",
  "session.preview.sourceOutsideWorkspace": "Priekšskatījuma avots ir ārpus aktīvās darbtelpas",
  "session.preview.inspectorError": "Priekšskatījuma inspektora kļūda",
  "session.preview.inspect": "Pārbaudīt",
  "session.preview.reload": "Pārlādēt",
  "session.preview.logs": "Žurnāli",
  "session.preview.heading": "Priekšskatiet savu React lietotni",
  "session.preview.starting": "Sāk priekšskatījumu...",
  "session.preview.description":
    "Palaiž darbtelpas izstrādes skriptu portā {{port}}. Pievienojiet @opencode-ai/preview/vite savai Vite konfigurācijai, lai iespējotu avota pārbaudi.",
  "session.preview.directory": "Projekta direktorijs",
  "session.preview.port": "Ports",
  "session.preview.start": "Sākt priekšskatījumu",
  "session.preview.restart": "Restartēt priekšskatījumu",
  "session.preview.serverUnreachable": "Priekšskatījuma serveris nekļuva sasniedzams adresē {{url}}",
  "session.preview.processExited": "Priekšskatījuma process beidzās ar kodu {{code}}",
