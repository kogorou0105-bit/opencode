export const dict = {
  ...
  "command.preview.description": "Ejecutar e inspeccionar la app React del espacio de trabajo",
  ...
  "session.preview.locatorUnavailable": "Localizador no disponible",
  "session.preview.sourceOutsideWorkspace": "El origen de la vista previa está fuera del espacio de trabajo activo",
  "session.preview.inspectorError": "Error del inspector de vista previa",
  "session.preview.inspect": "Inspeccionar",
  "session.preview.reload": "Recargar",
  "session.preview.logs": "Registros",
  "session.preview.heading": "Vista previa de tu app React",
  "session.preview.starting": "Iniciando vista previa...",
  "session.preview.description":
    "Ejecuta el script dev del espacio de trabajo en el puerto {{port}}. Añade @opencode-ai/preview/vite a tu configuración de Vite para habilitar la inspección del origen.",
  "session.preview.directory": "Directorio del proyecto",
  "session.preview.port": "Puerto",
  "session.preview.start": "Iniciar vista previa",
  "session.preview.restart": "Reiniciar vista previa",
  "session.preview.serverUnreachable": "El servidor de vista previa no respondió en {{url}}",
  "session.preview.processExited": "El proceso de vista previa terminó con el código {{code}}",
