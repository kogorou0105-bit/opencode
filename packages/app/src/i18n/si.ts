export const dict: Record<string, string> = {
  ...
  "command.preview.description": "වැඩබිම් React යෙදුම ධාවනය කර පරීක්ෂා කරන්න",
  ...
  "session.tab.preview": "පෙරදසුන",
  "session.tab.unknown": "නොදන්නා සැසිය",
  "session.preview.locatorUnavailable": "ස්ථානගතකය නොමැත",
  "session.preview.sourceOutsideWorkspace": "පෙරදසුන් මූලාශ්‍රය සක්‍රිය වැඩබිමෙන් පිටතය",
  "session.preview.inspectorError": "පෙරදසුන් පරීක්ෂක දෝෂය",
  "session.preview.inspect": "පරීක්ෂා කරන්න",
  "session.preview.reload": "නැවත පූරණය කරන්න",
  "session.preview.logs": "ලොග",
  "session.preview.heading": "ඔබේ React යෙදුම පෙරදසුන් කරන්න",
  "session.preview.starting": "පෙරදසුන ආරම්භ කරමින්...",
  "session.preview.description":
    "වැඩබිම් dev ස්ක්‍රිප්ටය {{port}} වරායේ ධාවනය කරයි. මූලාශ්‍ර පරීක්ෂාව සබල කිරීමට ඔබේ Vite වින්‍යාසයට @opencode-ai/preview/vite එක් කරන්න.",
  "session.preview.directory": "ව්‍යාපෘති නාමාවලිය",
  "session.preview.port": "වරාය",
  "session.preview.start": "පෙරදසුන අරඹන්න",
  "session.preview.restart": "පෙරදසුන යළි අරඹන්න",
  "session.preview.serverUnreachable": "පෙරදසුන් සේවාදායකය {{url}} හි ළඟා විය නොහැකි විය",
  "session.preview.processExited": "පෙරදසුන් ක්‍රියාවලිය {{code}} කේතයෙන් නික්මිණි",
