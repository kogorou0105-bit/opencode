export const dict = {
  ...
  "command.preview.description": "Exécuter et inspecter l'application React de l'espace de travail",
  ...
  "session.preview.locatorUnavailable": "Localisateur indisponible",
  "session.preview.sourceOutsideWorkspace": "La source de l'aperçu est en dehors de l'espace de travail actif",
  "session.preview.inspectorError": "Erreur de l'inspecteur d'aperçu",
  "session.preview.inspect": "Inspecter",
  "session.preview.reload": "Recharger",
  "session.preview.logs": "Journaux",
  "session.preview.heading": "Prévisualisez votre application React",
  "session.preview.starting": "Démarrage de l'aperçu...",
  "session.preview.description":
    "Exécute le script de développement de l'espace de travail sur le port {{port}}. Ajoutez @opencode-ai/preview/vite à votre configuration Vite pour activer l'inspection de la source.",
  "session.preview.directory": "Répertoire du projet",
  "session.preview.port": "Port",
  "session.preview.start": "Démarrer l'aperçu",
  "session.preview.restart": "Redémarrer l'aperçu",
  "session.preview.serverUnreachable": "Le serveur d'aperçu n'est pas devenu accessible à {{url}}",
  "session.preview.processExited": "Le processus d'aperçu s'est terminé avec le code {{code}}",
