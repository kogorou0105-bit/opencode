export const dict = {
  ...
  "command.preview.description": "Ish maydoni React ilovasini ishga tushiring va tekshiring",
  ...
  "session.tab.preview": "Koʻrib chiqish",
  "session.tab.unknown": "Noma'lum sessiya",
  "session.panel.reviewAndFiles": "Ko'rib chiqish va fayllar",
  "session.preview.locatorUnavailable": "Lokator mavjud emas",
  "session.preview.sourceOutsideWorkspace": "Koʻrib chiqish manbai faol ish maydonidan tashqarida",
  "session.preview.inspectorError": "Koʻrib chiqish inspektori xatosi",
  "session.preview.inspect": "Tekshirish",
  "session.preview.reload": "Qayta yuklash",
  "session.preview.logs": "Jurnallar",
  "session.preview.heading": "React ilovangizni koʻrib chiqing",
  "session.preview.starting": "Koʻrib chiqish boshlanmoqda...",
  "session.preview.description":
    "Ish maydoni dev skriptini {{port}} portida ishga tushiradi. Manbani tekshirishni yoqish uchun Vite konfiguratsiyangizga @opencode-ai/preview/vite ni qoʻshing.",
  "session.preview.directory": "Loyiha katalogi",
  "session.preview.port": "Port",
  "session.preview.start": "Koʻrib chiqishni boshlash",
  "session.preview.restart": "Koʻrib chiqishni qayta ishga tushirish",
  "session.preview.serverUnreachable": "Koʻrib chiqish serveri {{url}} manzilida ishga tushmadi",
  "session.preview.processExited": "Koʻrib chiqish jarayoni {{code}} kodi bilan yakunlandi",
