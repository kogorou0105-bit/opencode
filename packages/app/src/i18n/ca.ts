export const dict = {
  ...
  "command.preview.description": "Executa i inspecciona l'aplicació React de l'espai de treball",
  ...
  "session.tab.preview": "Vista prèvia",
  "session.tab.unknown": "Sessió desconeguda",
  "session.preview.locatorUnavailable": "Localitzador no disponible",
  "session.preview.sourceOutsideWorkspace": "L'origen de la vista prèvia és fora de l'espai de treball actiu",
  "session.preview.inspectorError": "Error de l'inspector de la vista prèvia",
  "session.preview.inspect": "Inspecciona",
  "session.preview.reload": "Torna a carregar",
  "session.preview.logs": "Registres",
  "session.preview.heading": "Previsualitza la teva aplicació React",
  "session.preview.starting": "S'està iniciant la vista prèvia...",
  "session.preview.description":
    "Executa l'script de desenvolupament de l'espai de treball al port {{port}}. Afegeix @opencode-ai/preview/vite a la configuració de Vite per activar la inspecció d'origen.",
  "session.preview.directory": "Directori del projecte",
  "session.preview.port": "Port",
  "session.preview.start": "Inicia la vista prèvia",
  "session.preview.restart": "Reinicia la vista prèvia",
  "session.preview.serverUnreachable": "El servidor de vista prèvia no ha estat accessible a {{url}}",
  "session.preview.processExited": "El procés de vista prèvia ha finalitzat amb el codi {{code}}",
