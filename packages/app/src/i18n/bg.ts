export const dict = {
  ...
  "command.preview.description": "Стартиране и проверка на React приложението в работното пространство",
  ...
  "session.tab.preview": "Визуализация",
  "session.tab.unknown": "Неизвестна сесия",
  "session.preview.locatorUnavailable": "Локаторът не е наличен",
  "session.preview.sourceOutsideWorkspace": "Източникът на визуализацията е извън активното работно пространство",
  "session.preview.inspectorError": "Грешка в инспектора на визуализацията",
  "session.preview.inspect": "Проверка",
  "session.preview.reload": "Презареждане",
  "session.preview.logs": "Дневници",
  "session.preview.heading": "Визуализирайте своето React приложение",
  "session.preview.starting": "Стартиране на визуализацията...",
  "session.preview.description":
    "Изпълнява dev скрипта на работното пространство на порт {{port}}. Добавете @opencode-ai/preview/vite към своята Vite конфигурация, за да активирате проверка на източника.",
  "session.preview.directory": "Директория на проекта",
  "session.preview.port": "Порт",
  "session.preview.start": "Стартиране на визуализацията",
  "session.preview.restart": "Рестартиране на визуализацията",
  "session.preview.serverUnreachable": "Сървърът за визуализация не стана достижим на {{url}}",
  "session.preview.processExited": "Процесът на визуализация приключи с код {{code}}",
