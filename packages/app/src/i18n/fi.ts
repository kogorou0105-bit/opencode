export const dict = {
  ...
  "command.preview.description": "Suorita työtilan React-sovellus ja tarkastele sitä",
  ...
  "session.tab.preview": "Esikatselu",
  "session.tab.unknown": "Tuntematon istunto",
  "session.preview.locatorUnavailable": "Paikannin ei ole käytettävissä",
  "session.preview.sourceOutsideWorkspace": "Esikatselun lähde on aktiivisen työtilan ulkopuolella",
  "session.preview.inspectorError": "Esikatselun tarkastusvirhe",
  "session.preview.inspect": "Tarkasta",
  "session.preview.reload": "Lataa uudelleen",
  "session.preview.logs": "Lokit",
  "session.preview.heading": "Esikatsele React-sovellustasi",
  "session.preview.starting": "Käynnistetään esikatselua...",
  "session.preview.description":
    "Suorittaa työtilan dev-skriptin portissa {{port}}. Lisää @opencode-ai/preview/vite Vite-määritykseesi ottaaksesi lähdetarkastelun käyttöön.",
  "session.preview.directory": "Projektihakemisto",
  "session.preview.port": "Portti",
  "session.preview.start": "Käynnistä esikatselu",
  "session.preview.restart": "Käynnistä esikatselu uudelleen",
  "session.preview.serverUnreachable": "Esikatselupalvelin ei tullut tavoitettavaksi osoitteessa {{url}}",
  "session.preview.processExited": "Esikatseluprosessi päättyi koodilla {{code}}",
