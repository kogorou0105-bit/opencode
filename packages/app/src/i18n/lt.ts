...
export const dict = {
  ...
  "command.preview.description": "Paleiskite ir tikrinkite darbo srities React programą",
  ...
  "session.tab.preview": "Peržiūra",
  "session.tab.unknown": "Nežinomas seansas",
  "session.preview.locatorUnavailable": "Vietos nustatymas nepasiekiamas",
  "session.preview.sourceOutsideWorkspace": "Peržiūros šaltinis yra už aktyvios darbo srities ribų",
  "session.preview.inspectorError": "Peržiūros tikrinimo klaida",
  "session.preview.inspect": "Tikrinti",
  "session.preview.reload": "Įkelti iš naujo",
  "session.preview.logs": "Žurnalai",
  "session.preview.heading": "Peržiūrėkite savo React programą",
  "session.preview.starting": "Pradedama peržiūra...",
  "session.preview.description":
    "Paleidžia darbo srities kūrimo scenarijų per prievadą {{port}}. Pridėkite @opencode-ai/preview/vite prie savo Vite konfigūracijos, kad įjungtumėte šaltinio tikrinimą.",
  "session.preview.directory": "Projekto katalogas",
  "session.preview.port": "Prievadas",
  "session.preview.start": "Pradėti peržiūrą",
  "session.preview.restart": "Paleisti peržiūrą iš naujo",
  "session.preview.serverUnreachable": "Peržiūros serveris nepasiekiamas adresu {{url}}",
  "session.preview.processExited": "Peržiūros procesas baigėsi su kodu {{code}}",
