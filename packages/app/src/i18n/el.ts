export const dict = {
  ...
  "command.preview.description": "Εκτέλεση και επιθεώρηση της εφαρμογής React του χώρου εργασίας",
  ...
  "session.tab.preview": "Προεπισκόπηση",
  "session.tab.unknown": "Άγνωστη συνεδρία",
  "session.preview.locatorUnavailable": "Ο εντοπιστής δεν είναι διαθέσιμος",
  "session.preview.sourceOutsideWorkspace": "Η πηγή προεπισκόπησης βρίσκεται εκτός του ενεργού χώρου εργασίας",
  "session.preview.inspectorError": "Σφάλμα επιθεωρητή προεπισκόπησης",
  "session.preview.inspect": "Επιθεώρηση",
  "session.preview.reload": "Επαναφόρτωση",
  "session.preview.logs": "Αρχεία καταγραφής",
  "session.preview.heading": "Προεπισκόπηση της εφαρμογής React",
  "session.preview.starting": "Έναρξη προεπισκόπησης...",
  "session.preview.description":
    "Εκτελεί το σενάριο dev του χώρου εργασίας στη θύρα {{port}}. Προσθέστε το @opencode-ai/preview/vite στη διαμόρφωση Vite για να ενεργοποιήσετε την επιθεώρηση πηγής.",
  "session.preview.directory": "Κατάλογος έργου",
  "session.preview.port": "Θύρα",
  "session.preview.start": "Έναρξη προεπισκόπησης",
  "session.preview.restart": "Επανεκκίνηση προεπισκόπησης",
  "session.preview.serverUnreachable": "Ο διακομιστής προεπισκόπησης δεν κατέστη προσβάσιμος στο {{url}}",
  "session.preview.processExited": "Η διεργασία προεπισκόπησης τερματίστηκε με κωδικό {{code}}",
