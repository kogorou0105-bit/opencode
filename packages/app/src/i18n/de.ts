...
export const dict = {
  ...
  "command.preview.description": "Die React-App des Arbeitsbereichs ausführen und prüfen",
  ...
  "session.preview.locatorUnavailable": "Locator nicht verfügbar",
  "session.preview.sourceOutsideWorkspace": "Die Vorschauquelle liegt außerhalb des aktiven Arbeitsbereichs",
  "session.preview.inspectorError": "Fehler im Vorschau-Inspektor",
  "session.preview.inspect": "Untersuchen",
  "session.preview.reload": "Neu laden",
  "session.preview.logs": "Protokolle",
  "session.preview.heading": "Vorschau Ihrer React-App",
  "session.preview.starting": "Vorschau wird gestartet…",
  "session.preview.description":
    "Führt das Dev-Skript des Arbeitsbereichs auf Port {{port}} aus. Fügen Sie @opencode-ai/preview/vite zu Ihrer Vite-Konfiguration hinzu, um die Quellcode-Prüfung zu aktivieren.",
  "session.preview.directory": "Projektverzeichnis",
  "session.preview.port": "Port",
  "session.preview.start": "Vorschau starten",
  "session.preview.restart": "Vorschau neu starten",
  "session.preview.serverUnreachable": "Der Vorschau-Server war unter {{url}} nicht erreichbar",
  "session.preview.processExited": "Der Vorschau-Prozess wurde mit Code {{code}} beendet",
