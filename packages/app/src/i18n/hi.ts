export const dict = {
  ...
  "command.preview.description": "वर्कस्पेस React ऐप चलाएँ और उसका निरीक्षण करें",
  ...
  "session.preview.locatorUnavailable": "लोकेटर अनुपलब्ध",
  "session.preview.sourceOutsideWorkspace": "पूर्वावलोकन स्रोत सक्रिय वर्कस्पेस के बाहर है",
  "session.preview.inspectorError": "पूर्वावलोकन निरीक्षक त्रुटि",
  "session.preview.inspect": "निरीक्षण करें",
  "session.preview.reload": "पुनः लोड करें",
  "session.preview.logs": "लॉग",
  "session.preview.heading": "अपने React ऐप का पूर्वावलोकन करें",
  "session.preview.starting": "पूर्वावलोकन शुरू हो रहा है...",
  "session.preview.description":
    "पोर्ट {{port}} पर वर्कस्पेस dev स्क्रिप्ट चलाता है। स्रोत निरीक्षण सक्षम करने के लिए अपने Vite कॉन्फ़िगर में @opencode-ai/preview/vite जोड़ें।",
  "session.preview.directory": "प्रोजेक्ट निर्देशिका",
  "session.preview.port": "पोर्ट",
  "session.preview.start": "पूर्वावलोकन शुरू करें",
  "session.preview.restart": "पूर्वावलोकन पुनः आरंभ करें",
  "session.preview.serverUnreachable": "पूर्वावलोकन सर्वर {{url}} पर उपलब्ध नहीं हुआ",
  "session.preview.processExited": "पूर्वावलोकन प्रक्रिया कोड {{code}} के साथ समाप्त हुई",
