export const dict = {
  ...
  "command.preview.description": "გაუშვით და შეამოწმეთ სამუშაო სივრცის React აპი",
  ...
  "session.tab.preview": "გადახედვა",
  "session.tab.unknown": "უცნობი სესია",
  "session.preview.locatorUnavailable": "ლოკატორი მიუწვდომელია",
  "session.preview.sourceOutsideWorkspace": "გადახედვის წყარო აქტიური სამუშაო სივრცის გარეთაა",
  "session.preview.inspectorError": "გადახედვის ინსპექტორის შეცდომა",
  "session.preview.inspect": "გამოკვლევა",
  "session.preview.reload": "განახლება",
  "session.preview.logs": "ჟურნალები",
  "session.preview.heading": "გადახედეთ თქვენს React აპს",
  "session.preview.starting": "გადახედვა იწყება...",
  "session.preview.description":
    "იშვებს სამუშაო სივრცის dev სკრიპტს პორტზე {{port}}. წყაროს შესამოწმებლად დაამატეთ @opencode-ai/preview/vite თქვენს Vite კონფიგურაციაში.",
  "session.preview.directory": "პროექტის დირექტორია",
  "session.preview.port": "პორტი",
  "session.preview.start": "გადახედვის დაწყება",
  "session.preview.restart": "გადახედვის გადატვირთვა",
  "session.preview.serverUnreachable": "გადახედვის სერვერი მიუწვდომელი დარჩა {{url}}-ზე",
  "session.preview.processExited": "გადახედვის პროცესი დასრულდა კოდით {{code}}",
