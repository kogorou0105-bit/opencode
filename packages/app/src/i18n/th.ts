export const dict = {
  ...
  "command.preview.description": "เรียกใช้และตรวจสอบแอป React ของพื้นที่ทำงาน",
  ...
  "session.tab.preview": "แสดงตัวอย่าง",
  "session.tab.unknown": "เซสชันที่ไม่รู้จัก",
  "session.preview.locatorUnavailable": "ไม่พร้อมใช้งานตัวระบุตำแหน่ง",
  "session.preview.sourceOutsideWorkspace": "แหล่งที่มาของการแสดงตัวอย่างอยู่นอกพื้นที่ทำงานที่ใช้งานอยู่",
  "session.preview.inspectorError": "ข้อผิดพลาดของเครื่องมือตรวจสอบการแสดงตัวอย่าง",
  "session.preview.inspect": "ตรวจสอบ",
  "session.preview.reload": "โหลดใหม่",
  "session.preview.logs": "บันทึก",
  "session.preview.heading": "แสดงตัวอย่างแอป React ของคุณ",
  "session.preview.starting": "กำลังเริ่มการแสดงตัวอย่าง...",
  "session.preview.description":
    "เรียกใช้สคริปต์ dev ของพื้นที่ทำงานบนพอร์ต {{port}} เพิ่ม @opencode-ai/preview/vite ในคอนฟิก Vite เพื่อเปิดใช้งานการตรวจสอบซอร์ส",
  "session.preview.directory": "ไดเรกทอรีโปรเจกต์",
  "session.preview.port": "พอร์ต",
  "session.preview.start": "เริ่มการแสดงตัวอย่าง",
  "session.preview.restart": "เริ่มการแสดงตัวอย่างใหม่",
  "session.preview.serverUnreachable": "เซิร์ฟเวอร์แสดงตัวอย่างไม่พร้อมใช้งานที่ {{url}}",
  "session.preview.processExited": "กระบวนการแสดงตัวอย่างสิ้นสุดด้วยรหัส {{code}}",
