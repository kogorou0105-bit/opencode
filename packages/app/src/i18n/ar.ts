export const dict = {
  ...
  "command.preview.description": "تشغيل تطبيق React في مساحة العمل وفحصه",
  ...
  "session.preview.locatorUnavailable": "المحدد غير متاح",
  "session.preview.sourceOutsideWorkspace": "مصدر المعاينة خارج مساحة العمل النشطة",
  "session.preview.inspectorError": "خطأ في فاحص المعاينة",
  "session.preview.inspect": "فحص",
  "session.preview.reload": "إعادة التحميل",
  "session.preview.logs": "السجلات",
  "session.preview.heading": "معاينة تطبيق React الخاص بك",
  "session.preview.starting": "جارٍ بدء المعاينة...",
  "session.preview.description":
    "يشغّل برنامج التطوير النصي لمساحة العمل على المنفذ {{port}}. أضف @opencode-ai/preview/vite إلى تكوين Vite لتمكين فحص المصدر.",
  "session.preview.directory": "دليل المشروع",
  "session.preview.port": "المنفذ",
  "session.preview.start": "بدء المعاينة",
  "session.preview.restart": "إعادة تشغيل المعاينة",
  "session.preview.serverUnreachable": "تعذّر الوصول إلى خادم المعاينة على {{url}}",
  "session.preview.processExited": "خرجت عملية المعاينة بالرمز {{code}}",
