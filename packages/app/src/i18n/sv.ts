export const dict = {
  ...
  "command.preview.description": "Kör och inspektera arbetsytans React-app",
  ...
  "session.tab.preview": "Förhandsvisning",
  "session.tab.unknown": "Okänd session",
  "session.preview.locatorUnavailable": "Lokalisering inte tillgänglig",
  "session.preview.sourceOutsideWorkspace": "Förhandsvisningskällan ligger utanför den aktiva arbetsytan",
  "session.preview.inspectorError": "Fel i förhandsvisningens inspektör",
  "session.preview.inspect": "Inspektera",
  "session.preview.reload": "Läs in igen",
  "session.preview.logs": "Loggar",
  "session.preview.heading": "Förhandsvisa din React-app",
  "session.preview.starting": "Startar förhandsvisning...",
  "session.preview.description":
    "Kör arbetsytans dev-skript på port {{port}}. Lägg till @opencode-ai/preview/vite i din Vite-konfiguration för att aktivera källinspektion.",
  "session.preview.directory": "Projektkatalog",
  "session.preview.port": "Port",
  "session.preview.start": "Starta förhandsvisning",
  "session.preview.restart": "Starta om förhandsvisning",
  "session.preview.serverUnreachable": "Förhandsvisningsservern blev inte nåbar på {{url}}",
  "session.preview.processExited": "Förhandsvisningsprocessen avslutades med kod {{code}}",
