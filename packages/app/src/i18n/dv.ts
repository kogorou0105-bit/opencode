export const dict = {
  ...
  "command.preview.description": "ވޯކްސްޕޭސް React އެޕް ހިންގައި ބަލާށެވެ",
  ...
  "session.tab.preview": "ޕްރިވިއު",
  "session.tab.unknown": "ނޭނގޭ ސެޝަނެއް",
  "session.preview.locatorUnavailable": "ލޮކޭޓަރ ނުލިބެއެވެ",
  "session.preview.sourceOutsideWorkspace": "ޕްރިވިއު ސޯސް އޮތީ އެކްޓިވް ވޯކްސްޕޭސްގެ ބޭރުގައެވެ",
  "session.preview.inspectorError": "ޕްރިވިއު އިންސްޕެކްޓަރ އެރަރ",
  "session.preview.inspect": "އިންސްޕެކްޓް",
  "session.preview.reload": "ރީލޯޑް",
  "session.preview.logs": "ލޮގްސް",
  "session.preview.heading": "ތިބާގެ React އެޕް ޕްރިވިއުކުރާށެވެ",
  "session.preview.starting": "ޕްރިވިއު ފަށަމުން...",
  "session.preview.description":
    "ވޯކްސްޕޭސް dev ސްކްރިޕްޓް {{port}} ޕޯޓްގައި ހިންގައެވެ. ސޯސް އިންސްޕެކްޝަން އެނެބަލްކުރުމަށް Vite ކޮންފިގަށް @opencode-ai/preview/vite އިތުރުކުރާށެވެ.",
  "session.preview.directory": "ޕްރޮޖެކްޓް ޑައިރެކްޓަރީ",
  "session.preview.port": "ޕޯޓް",
  "session.preview.start": "ޕްރިވިއު ފަށާށެވެ",
  "session.preview.restart": "ޕްރިވިއު އަލުން ފަށާށެވެ",
  "session.preview.serverUnreachable": "ޕްރިވިއު ސަރވަރ {{url}} ގައި ލިބޭ ގޮތެއް ނުވިއެވެ",
  "session.preview.processExited": "ޕްރިވިއު ޕްރޮސެސް ނިމުނީ ކޯޑް {{code}} އާއެކުގައެވެ",
