export const dict = {
  ...
  "command.preview.description": "Rulează și inspectează aplicația React din spațiul de lucru",
  ...
  "session.tab.preview": "Previzualizare",
  "session.tab.unknown": "Sesiune necunoscută",
  "session.preview.locatorUnavailable": "Localizator indisponibil",
  "session.preview.sourceOutsideWorkspace": "Sursa previzualizării este în afara spațiului de lucru activ",
  "session.preview.inspectorError": "Eroare inspector previzualizare",
  "session.preview.inspect": "Inspectează",
  "session.preview.reload": "Reîncarcă",
  "session.preview.logs": "Jurnale",
  "session.preview.heading": "Previzualizează-ți aplicația React",
  "session.preview.starting": "Se pornește previzualizarea...",
  "session.preview.description":
    "Rulează scriptul dev al spațiului de lucru pe portul {{port}}. Adaugă @opencode-ai/preview/vite în configurația Vite pentru a activa inspecția sursei.",
  "session.preview.directory": "Director proiect",
  "session.preview.port": "Port",
  "session.preview.start": "Pornește previzualizarea",
  "session.preview.restart": "Repornește previzualizarea",
  "session.preview.serverUnreachable": "Serverul de previzualizare nu a devenit accesibil la {{url}}",
  "session.preview.processExited": "Procesul de previzualizare s-a încheiat cu codul {{code}}",
