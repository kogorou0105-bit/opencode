export const dict: Record<string, string> = {
  ...
  "command.preview.description": "कार्यस्थान React एप चलाउनुहोस् र निरीक्षण गर्नुहोस्",
  ...
  "session.tab.preview": "पूर्वावलोकन",
  "session.tab.unknown": "अज्ञात सत्र",
  "session.preview.locatorUnavailable": "लोकेटर उपलब्ध छैन",
  "session.preview.sourceOutsideWorkspace": "पूर्वावलोकन स्रोत सक्रिय कार्यस्थान बाहिर छ",
  "session.preview.inspectorError": "पूर्वावलोकन निरीक्षक त्रुटि",
  "session.preview.inspect": "निरीक्षण गर्नुहोस्",
  "session.preview.reload": "पुन: लोड गर्नुहोस्",
  "session.preview.logs": "लगहरू",
  "session.preview.heading": "आफ्नो React एप पूर्वावलोकन गर्नुहोस्",
  "session.preview.starting": "पूर्वावलोकन सुरु गर्दै...",
  "session.preview.description":
    "पोर्ट {{port}} मा कार्यस्थान देव स्क्रिप्ट चलाउँछ। स्रोत निरीक्षण सक्षम गर्न आफ्नो Vite कन्फिगमा @opencode-ai/preview/vite थप्नुहोस्।",
  "session.preview.directory": "परियोजना डाइरेक्टरी",
  "session.preview.port": "पोर्ट",
  "session.preview.start": "पूर्वावलोकन सुरु गर्नुहोस्",
  "session.preview.restart": "पूर्वावलोकन पुन: सुरु गर्नुहोस्",
  "session.preview.serverUnreachable": "पूर्वावलोकन सर्भर {{url}} मा पहुँचयोग्य भएन",
  "session.preview.processExited": "पूर्वावलोकन प्रक्रिया कोड {{code}} सहित बाहिरियो",
