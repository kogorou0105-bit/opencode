export const dict = {
  ...
  "command.preview.description": "Jalankan dan periksa aplikasi React ruang kerja",
  ...
  "session.tab.preview": "Pratinjau",
  "session.tab.unknown": "Sesi Tidak Dikenal",
  "session.preview.locatorUnavailable": "Locator tidak tersedia",
  "session.preview.sourceOutsideWorkspace": "Sumber pratinjau berada di luar ruang kerja aktif",
  "session.preview.inspectorError": "Kesalahan inspektor pratinjau",
  "session.preview.inspect": "Periksa",
  "session.preview.reload": "Muat ulang",
  "session.preview.logs": "Log",
  "session.preview.heading": "Pratinjau aplikasi React Anda",
  "session.preview.starting": "Memulai pratinjau...",
  "session.preview.description":
    "Menjalankan skrip dev ruang kerja pada porta {{port}}. Tambahkan @opencode-ai/preview/vite ke konfigurasi Vite Anda untuk mengaktifkan inspeksi sumber.",
  "session.preview.directory": "Direktori proyek",
  "session.preview.port": "Porta",
  "session.preview.start": "Mulai pratinjau",
  "session.preview.restart": "Mulai ulang pratinjau",
  "session.preview.serverUnreachable": "Server pratinjau tidak dapat dijangkau di {{url}}",
  "session.preview.processExited": "Proses pratinjau berhenti dengan kode {{code}}",
