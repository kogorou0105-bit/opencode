export const dict = {
  ...
  "command.preview.description": "ワークスペースのReactアプリを実行して検証する",
  ...
  "session.preview.locatorUnavailable": "ロケーターを利用できません",
  "session.preview.sourceOutsideWorkspace": "プレビューのソースはアクティブなワークスペースの外にあります",
  "session.preview.inspectorError": "プレビューインスペクターのエラー",
  "session.preview.inspect": "検証",
  "session.preview.reload": "再読み込み",
  "session.preview.logs": "ログ",
  "session.preview.heading": "Reactアプリをプレビュー",
  "session.preview.starting": "プレビューを開始しています...",
  "session.preview.description":
    "ワークスペースの開発スクリプトをポート{{port}}で実行します。ソース検証を有効にするには、Vite設定に@opencode-ai/preview/viteを追加してください。",
  "session.preview.directory": "プロジェクトディレクトリ",
  "session.preview.port": "ポート",
  "session.preview.start": "プレビューを開始",
  "session.preview.restart": "プレビューを再起動",
  "session.preview.serverUnreachable": "プレビューサーバーは{{url}}で到達可能になりませんでした",
  "session.preview.processExited": "プレビュープロセスがコード{{code}}で終了しました",
