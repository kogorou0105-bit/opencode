...
export const dict = {
  ...
  "command.preview.description": "Çalışma alanı React uygulamasını çalıştırın ve inceleyin",
  ...
  "session.preview.locatorUnavailable": "Konum belirleyici kullanılamıyor",
  "session.preview.sourceOutsideWorkspace": "Önizleme kaynağı etkin çalışma alanının dışında",
  "session.preview.inspectorError": "Önizleme inceleme hatası",
  "session.preview.inspect": "İncele",
  "session.preview.reload": "Yeniden yükle",
  "session.preview.logs": "Günlükler",
  "session.preview.heading": "React uygulamanızı önizleyin",
  "session.preview.starting": "Önizleme başlatılıyor...",
  "session.preview.description":
    "Çalışma alanı geliştirme betiğini {{port}} bağlantı noktasında çalıştırır. Kaynak incelemeyi etkinleştirmek için Vite yapılandırmanıza @opencode-ai/preview/vite ekleyin.",
  "session.preview.directory": "Proje dizini",
  "session.preview.port": "Bağlantı noktası",
  "session.preview.start": "Önizlemeyi başlat",
  "session.preview.restart": "Önizlemeyi yeniden başlat",
  "session.preview.serverUnreachable": "Önizleme sunucusuna {{url}} adresinde erişilemedi",
  "session.preview.processExited": "Önizleme işlemi {{code}} koduyla sona erdi",
