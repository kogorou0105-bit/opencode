...
export const dict = {
  ...
  "command.preview.description": "Kjør og inspiser React-appen i arbeidsområdet",
  ...
  "session.preview.locatorUnavailable": "Lokalisering er utilgjengelig",
  "session.preview.sourceOutsideWorkspace": "Forhåndsvisningskilden er utenfor det aktive arbeidsområdet",
  "session.preview.inspectorError": "Feil i forhåndsvisningsinspektøren",
  "session.preview.inspect": "Inspiser",
  "session.preview.reload": "Last inn på nytt",
  "session.preview.logs": "Logger",
  "session.preview.heading": "Forhåndsvis React-appen din",
  "session.preview.starting": "Starter forhåndsvisning...",
  "session.preview.description":
    "Kjører utviklingsskriptet i arbeidsområdet på port {{port}}. Legg til @opencode-ai/preview/vite i Vite-konfigurasjonen for å aktivere kildeinspeksjon.",
  "session.preview.directory": "Prosjektmappe",
  "session.preview.port": "Port",
  "session.preview.start": "Start forhåndsvisning",
  "session.preview.restart": "Start forhåndsvisning på nytt",
  "session.preview.serverUnreachable": "Forhåndsvisningsserveren ble ikke tilgjengelig på {{url}}",
  "session.preview.processExited": "Forhåndsvisningsprosessen ble avsluttet med kode {{code}}",
