export const dict = {
  ...
  "command.preview.description": "ورک سپیس React ایپ چلاؤ تے معائنہ کرو",
  ...
  "session.tab.preview": "پیش نظارہ",
  "session.tab.unknown": "نامعلوم سیشن",
  "session.preview.locatorUnavailable": "لوکیٹر دستیاب نئیں",
  "session.preview.sourceOutsideWorkspace": "پیش نظارہ دا ماخذ فعال ورک سپیس توں باہر اے",
  "session.preview.inspectorError": "پیش نظارہ انسپکٹر دی غلطی",
  "session.preview.inspect": "معائنہ کرو",
  "session.preview.reload": "دوبارہ لوڈ کرو",
  "session.preview.logs": "لاگ",
  "session.preview.heading": "اپنی React ایپ دا پیش نظارہ کرو",
  "session.preview.starting": "پیش نظارہ شروع ہو رہیا اے...",
  "session.preview.description":
    "ورک سپیس دی dev سکرپٹ نو پورٹ {{port}} تے چلاندا اے۔ ماخذ معائنے نوں چالو کرن لئی اپنی Vite کنفگ وچ @opencode-ai/preview/vite شامل کرو۔",
  "session.preview.directory": "پروجیکٹ ڈائریکٹری",
  "session.preview.port": "پورٹ",
  "session.preview.start": "پیش نظارہ شروع کرو",
  "session.preview.restart": "پیش نظارہ دوبارہ شروع کرو",
  "session.preview.serverUnreachable": "پیش نظارہ سرور {{url}} تے قابل رسائی نئیں ہویا",
  "session.preview.processExited": "پیش نظارہ عمل کوڈ {{code}} نال بند ہو گیا",
