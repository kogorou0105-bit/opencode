export const dict = {
  ...
  "command.preview.description": "Стартувај ја и провери ја React апликацијата во работниот простор",
  ...
  "session.tab.preview": "Преглед",
  "session.tab.unknown": "Непозната сесија",
  "session.preview.locatorUnavailable": "Локаторот е недостапен",
  "session.preview.sourceOutsideWorkspace": "Изворот за преглед е надвор од активниот работен простор",
  "session.preview.inspectorError": "Грешка во инспекторот за преглед",
  "session.preview.inspect": "Инспектирај",
  "session.preview.reload": "Вчитај повторно",
  "session.preview.logs": "Дневници",
  "session.preview.heading": "Прегледајте ја вашата React апликација",
  "session.preview.starting": "Прегледот се стартува...",
  "session.preview.description":
    "Ја извршува dev скриптата на работниот простор на порта {{port}}. Додајте @opencode-ai/preview/vite во вашата Vite конфигурација за да овозможите инспекција на изворот.",
  "session.preview.directory": "Проектна директорија",
  "session.preview.port": "Порта",
  "session.preview.start": "Започни преглед",
  "session.preview.restart": "Рестартирај преглед",
  "session.preview.serverUnreachable": "Серверот за преглед не стана достапен на {{url}}",
  "session.preview.processExited": "Процесот за преглед заврши со код {{code}}",
