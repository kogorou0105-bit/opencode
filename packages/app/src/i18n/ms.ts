export const dict = {
  ...
  "session.tab.preview": "Pratonton",
  "session.tab.unknown": "Sesi Tidak Diketahui",
  "session.preview.locatorUnavailable": "Penentu lokasi tidak tersedia",
  "session.preview.sourceOutsideWorkspace": "Sumber pratonton berada di luar ruang kerja aktif",
  "session.preview.inspectorError": "Ralat pemeriksa pratonton",
  "session.preview.inspect": "Periksa",
  "session.preview.reload": "Muat Semula",
  "session.preview.logs": "Log",
  "session.preview.heading": "Pratonton aplikasi React anda",
  "session.preview.starting": "Memulakan pratonton...",
  "session.preview.description":
    "Menjalankan skrip dev ruang kerja pada port {{port}}. Tambah @opencode-ai/preview/vite pada konfigurasi Vite anda untuk membolehkan pemeriksaan sumber.",
  "session.preview.directory": "Direktori projek",
  "session.preview.port": "Port",
  "session.preview.start": "Mulakan pratonton",
  "session.preview.restart": "Mulakan semula pratonton",
  "session.preview.serverUnreachable": "Pelayan pratonton tidak dapat dihubungi di {{url}}",
  "session.preview.processExited": "Proses pratonton keluar dengan kod {{code}}",
