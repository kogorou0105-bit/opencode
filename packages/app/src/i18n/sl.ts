export const dict = {
  ...
  "command.preview.description": "Zaženi in preglej aplikacijo React v delovnem prostoru",
  ...
  "session.tab.preview": "Predogled",
  "session.tab.unknown": "Neznana seja",
  "session.panel.reviewAndFiles": "Pregled in datoteke",
  "session.preview.locatorUnavailable": "Lokator ni na voljo",
  "session.preview.sourceOutsideWorkspace": "Vir predogleda je zunaj aktivnega delovnega prostora",
  "session.preview.inspectorError": "Napaka inšpektorja predogleda",
  "session.preview.inspect": "Preglej",
  "session.preview.reload": "Ponovno naloži",
  "session.preview.logs": "Dnevniki",
  "session.preview.heading": "Predoglejte svojo aplikacijo React",
  "session.preview.starting": "Zagon predogleda ...",
  "session.preview.description":
    "Zažene razvojni skript delovnega prostora na vratih {{port}}. Dodajte @opencode-ai/preview/vite v svojo konfiguracijo Vite, da omogočite pregled izvora.",
  "session.preview.directory": "Imenik projekta",
  "session.preview.port": "Vrata",
  "session.preview.start": "Zaženi predogled",
  "session.preview.restart": "Znova zaženi predogled",
  "session.preview.serverUnreachable": "Strežnik za predogled ni postal dosegljiv na {{url}}",
  "session.preview.processExited": "Proces predogleda se je končal s kodo {{code}}",
