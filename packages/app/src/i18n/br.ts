export const dict = {
  ...
  "command.preview.description": "Executar e inspecionar o app React do espaço de trabalho",
  ...
  "session.tab.preview": "Prévia",
  "session.tab.unknown": "Sessão desconhecida",
  "session.preview.locatorUnavailable": "Localizador indisponível",
  "session.preview.sourceOutsideWorkspace": "A origem da prévia está fora do espaço de trabalho ativo",
  "session.preview.inspectorError": "Erro no inspetor da prévia",
  "session.preview.inspect": "Inspecionar",
  "session.preview.reload": "Recarregar",
  "session.preview.logs": "Logs",
  "session.preview.heading": "Visualize seu app React",
  "session.preview.starting": "Iniciando prévia...",
  "session.preview.description":
    "Executa o script dev do espaço de trabalho na porta {{port}}. Adicione @opencode-ai/preview/vite à sua configuração do Vite para ativar a inspeção de origem.",
  "session.preview.directory": "Diretório do projeto",
  "session.preview.port": "Porta",
  "session.preview.start": "Iniciar prévia",
  "session.preview.restart": "Reiniciar prévia",
  "session.preview.serverUnreachable": "O servidor da prévia não ficou acessível em {{url}}",
  "session.preview.processExited": "O processo da prévia foi encerrado com o código {{code}}",
