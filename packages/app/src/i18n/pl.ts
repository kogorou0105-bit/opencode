export const dict = {
  ...
  "command.preview.description": "Uruchom aplikację React z przestrzeni roboczej i sprawdź ją",
  ...
  "session.preview.locatorUnavailable": "Lokalizator niedostępny",
  "session.preview.sourceOutsideWorkspace": "Źródło podglądu znajduje się poza aktywną przestrzenią roboczą",
  "session.preview.inspectorError": "Błąd inspektora podglądu",
  "session.preview.inspect": "Sprawdź",
  "session.preview.reload": "Wczytaj ponownie",
  "session.preview.logs": "Dzienniki",
  "session.preview.heading": "Wyświetl podgląd swojej aplikacji React",
  "session.preview.starting": "Uruchamianie podglądu...",
  "session.preview.description":
    "Uruchamia skrypt deweloperski przestrzeni roboczej na porcie {{port}}. Dodaj @opencode-ai/preview/vite do konfiguracji Vite, aby włączyć inspekcję źródła.",
  "session.preview.directory": "Katalog projektu",
  "session.preview.port": "Port",
  "session.preview.start": "Uruchom podgląd",
  "session.preview.restart": "Uruchom ponownie podgląd",
  "session.preview.serverUnreachable": "Serwer podglądu nie stał się osiągalny pod adresem {{url}}",
  "session.preview.processExited": "Proces podglądu zakończył działanie z kodem {{code}}",
