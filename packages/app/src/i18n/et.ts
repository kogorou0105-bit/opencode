export const dict = {
  ...
  "command.preview.description": "Käivita ja kontrolli tööruumi Reacti rakendust",
  ...
  "session.tab.preview": "Eelvaade",
  "session.tab.unknown": "Tundmatu seanss",
  "session.preview.locatorUnavailable": "Lokaator pole saadaval",
  "session.preview.sourceOutsideWorkspace": "Eelvaate allikas on väljaspool aktiivset tööruumi",
  "session.preview.inspectorError": "Eelvaate inspektori viga",
  "session.preview.inspect": "Kontrolli",
  "session.preview.reload": "Laadi uuesti",
  "session.preview.logs": "Logid",
  "session.preview.heading": "Vaata oma Reacti rakenduse eelvaadet",
  "session.preview.starting": "Eelvaate käivitamine...",
  "session.preview.description":
    "Käivitab tööruumi arendusskripti pordil {{port}}. Lisa allika kontrollimise lubamiseks oma Vite'i konfiguratsiooni @opencode-ai/preview/vite.",
  "session.preview.directory": "Projekti kataloog",
  "session.preview.port": "Port",
  "session.preview.start": "Käivita eelvaade",
  "session.preview.restart": "Taaskäivita eelvaade",
  "session.preview.serverUnreachable": "Eelvaate server ei muutunud kättesaadavaks aadressil {{url}}",
  "session.preview.processExited": "Eelvaate protsess väljus koodiga {{code}}",
