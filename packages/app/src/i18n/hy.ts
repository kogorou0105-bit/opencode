export const dict = {
  ...
  "command.preview.description": "Գործարկել և զննել աշխատանքային տարածքի React հավելվածը",
  ...
  "session.tab.preview": "Նախադիտում",
  "session.tab.unknown": "Անհայտ նիստ",
  "session.preview.locatorUnavailable": "Տեղորոշիչն անհասանելի է",
  "session.preview.sourceOutsideWorkspace": "Նախադիտման աղբյուրը ակտիվ աշխատանքային տարածքից դուրս է",
  "session.preview.inspectorError": "Նախադիտման զննիչի սխալ",
  "session.preview.inspect": "Զննել",
  "session.preview.reload": "Վերաբեռնել",
  "session.preview.logs": "Մատյաններ",
  "session.preview.heading": "Նախադիտեք ձեր React հավելվածը",
  "session.preview.starting": "Նախադիտումը մեկնարկում է...",
  "session.preview.description":
    "Գործարկում է աշխատանքային տարածքի dev սկրիպտը {{port}} միացքի վրա։ Աղբյուրի զննումը միացնելու համար ավելացրեք @opencode-ai/preview/vite-ը ձեր Vite կազմաձևում։",
  "session.preview.directory": "Նախագծի գրացուցակ",
  "session.preview.port": "Միացք",
  "session.preview.start": "Մեկնարկել նախադիտումը",
  "session.preview.restart": "Վերագործարկել նախադիտումը",
  "session.preview.serverUnreachable": "Նախադիտման սերվերը հասանելի չդարձավ {{url}} հասցեում",
  "session.preview.processExited": "Նախադիտման գործընթացն ավարտվեց {{code}} կոդով",
