...
export const dict = {
  ...
  "command.preview.description": "Futtassa és vizsgálja meg a munkaterület React-alkalmazását",
  ...
  "session.tab.preview": "Előnézet",
  "session.tab.unknown": "Ismeretlen munkamenet",
  "session.preview.locatorUnavailable": "A lokátor nem érhető el",
  "session.preview.sourceOutsideWorkspace": "Az előnézeti forrás az aktív munkaterületen kívül van",
  "session.preview.inspectorError": "Előnézeti vizsgáló hiba",
  "session.preview.inspect": "Vizsgálat",
  "session.preview.reload": "Újratöltés",
  "session.preview.logs": "Naplók",
  "session.preview.heading": "Tekintse meg React-alkalmazása előnézetét",
  "session.preview.starting": "Előnézet indítása...",
  "session.preview.description":
    "Futtatja a munkaterület dev-szkriptjét a(z) {{port}} porton. Adja hozzá a @opencode-ai/preview/vite csomagot a Vite-konfigurációhoz a forrásvizsgálat engedélyezéséhez.",
  "session.preview.directory": "Projektkönyvtár",
  "session.preview.port": "Port",
  "session.preview.start": "Előnézet indítása",
  "session.preview.restart": "Előnézet újraindítása",
  "session.preview.serverUnreachable": "Az előnézeti kiszolgáló nem vált elérhetővé itt: {{url}}",
  "session.preview.processExited": "Az előnézeti folyamat kilépett, kód: {{code}}",
