export const dict = {
  ...
  "command.preview.description": "ورک اسپیس React ایپ چلائیں اور اس کا معائنہ کریں",
  ...
  "session.tab.preview": "پیش منظر",
  "session.tab.unknown": "نامعلوم سیشن",
  "session.preview.locatorUnavailable": "لوکیٹر دستیاب نہیں ہے",
  "session.preview.sourceOutsideWorkspace": "پیش منظر کا ماخذ فعال ورک اسپیس سے باہر ہے",
  "session.preview.inspectorError": "پیش منظر کے معائنہ کار کی خرابی",
  "session.preview.inspect": "معائنہ کریں",
  "session.preview.reload": "دوبارہ لوڈ کریں",
  "session.preview.logs": "لاگز",
  "session.preview.heading": "اپنی React ایپ کا پیش منظر دیکھیں",
  "session.preview.starting": "پیش منظر شروع ہو رہا ہے...",
  "session.preview.description":
    "ورک اسپیس کی dev اسکرپٹ پورٹ {{port}} پر چلاتا ہے۔ ماخذ کے معائنے کو فعال کرنے کے لیے اپنی Vite کنفگ میں @opencode-ai/preview/vite شامل کریں۔",
  "session.preview.directory": "پروجیکٹ ڈائریکٹری",
  "session.preview.port": "پورٹ",
  "session.preview.start": "پیش منظر شروع کریں",
  "session.preview.restart": "پیش منظر دوبارہ شروع کریں",
  "session.preview.serverUnreachable": "پیش منظر سرور {{url}} پر قابل رسائی نہ ہو سکا",
  "session.preview.processExited": "پیش منظر کا عمل کوڈ {{code}} کے ساتھ بند ہو گیا",
