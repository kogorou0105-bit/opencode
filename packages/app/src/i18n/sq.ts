export const dict = {
  ...
  "command.preview.description": "Ekzekuto dhe inspekto aplikacionin React të hapësirës së punës",
  ...
  "session.tab.preview": "Pamja paraprake",
  "session.tab.unknown": "Sesion i panjohur",
  "session.preview.locatorUnavailable": "Lokatori i padisponueshëm",
  "session.preview.sourceOutsideWorkspace": "Burimi i pamjes paraprake është jashtë hapësirës aktive të punës",
  "session.preview.inspectorError": "Gabim i inspektuesit të pamjes paraprake",
  "session.preview.inspect": "Inspekto",
  "session.preview.reload": "Ringarko",
  "session.preview.logs": "Regjistrat",
  "session.preview.heading": "Shfaq paraprakisht aplikacionin React",
  "session.preview.starting": "Po nis pamja paraprake...",
  "session.preview.description":
    "Ekzekuton skriptin dev të hapësirës së punës në portin {{port}}. Shto @opencode-ai/preview/vite në konfigurimin Vite për të aktivizuar inspektimin e burimit.",
  "session.preview.directory": "Drejtoria e projektit",
  "session.preview.port": "Porti",
  "session.preview.start": "Fillo pamjen paraprake",
  "session.preview.restart": "Rinis pamjen paraprake",
  "session.preview.serverUnreachable": "Serveri i pamjes paraprake nuk u bë i arritshëm në {{url}}",
  "session.preview.processExited": "Procesi i pamjes paraprake doli me kodin {{code}}",
