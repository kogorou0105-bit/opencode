export const dict: Record<string, string> = {
  ...
  "command.preview.description": "ওয়ার্কস্পেস React অ্যাপ চালান এবং পরিদর্শন করুন",
  ...
  "session.tab.preview": "প্রিভিউ",
  "session.tab.unknown": "অজানা সেশন",
  "session.preview.locatorUnavailable": "লোকেটর অনুপলব্ধ",
  "session.preview.sourceOutsideWorkspace": "প্রিভিউ উৎস সক্রিয় ওয়ার্কস্পেসের বাইরে",
  "session.preview.inspectorError": "প্রিভিউ পরিদর্শক ত্রুটি",
  "session.preview.inspect": "পরিদর্শন করুন",
  "session.preview.reload": "পুনরায় লোড করুন",
  "session.preview.logs": "লগ",
  "session.preview.heading": "আপনার React অ্যাপ প্রিভিউ করুন",
  "session.preview.starting": "প্রিভিউ শুরু হচ্ছে...",
  "session.preview.description":
    "পোর্ট {{port}}-এ ওয়ার্কস্পেস ডেভ স্ক্রিপ্ট চালায়। উৎস পরিদর্শন সক্ষম করতে আপনার Vite কনফিগে @opencode-ai/preview/vite যোগ করুন।",
  "session.preview.directory": "প্রকল্প ডিরেক্টরি",
  "session.preview.port": "পোর্ট",
  "session.preview.start": "প্রিভিউ শুরু করুন",
  "session.preview.restart": "প্রিভিউ পুনরায় চালু করুন",
  "session.preview.serverUnreachable": "প্রিভিউ সার্ভার {{url}}-এ পৌঁছানো যায়নি",
  "session.preview.processExited": "প্রিভিউ প্রক্রিয়া {{code}} কোড সহ প্রস্থান করেছে",
