...
export const dict = {
  ...
  "command.preview.description": "執行並檢查工作區的 React 應用程式",
  ...
  "session.preview.locatorUnavailable": "無法使用定位器",
  "session.preview.sourceOutsideWorkspace": "預覽來源位於使用中的工作區之外",
  "session.preview.inspectorError": "預覽檢查器錯誤",
  "session.preview.inspect": "檢查",
  "session.preview.reload": "重新載入",
  "session.preview.logs": "記錄",
  "session.preview.heading": "預覽你的 React 應用程式",
  "session.preview.starting": "正在啟動預覽...",
  "session.preview.description":
    "在連接埠 {{port}} 上執行工作區的開發腳本。在 Vite 設定中加入 @opencode-ai/preview/vite 以啟用來源檢查。",
  "session.preview.directory": "專案目錄",
  "session.preview.port": "連接埠",
  "session.preview.start": "啟動預覽",
  "session.preview.restart": "重新啟動預覽",
  "session.preview.serverUnreachable": "預覽伺服器無法在 {{url}} 連線",
  "session.preview.processExited": "預覽處理程序已結束，代碼為 {{code}}",
