export const dict = {
  ...
  "command.preview.description": "Kør og inspicér arbejdsområdets React-app",
  ...
  "session.preview.locatorUnavailable": "Lokalisering ikke tilgængelig",
  "session.preview.sourceOutsideWorkspace": "Forhåndsvisningskilden er uden for det aktive arbejdsområde",
  "session.preview.inspectorError": "Fejl i forhåndsvisningsinspektøren",
  "session.preview.inspect": "Inspicér",
  "session.preview.reload": "Genindlæs",
  "session.preview.logs": "Logfiler",
  "session.preview.heading": "Vis din React-app i forhåndsvisning",
  "session.preview.starting": "Starter forhåndsvisning...",
  "session.preview.description":
    "Kører arbejdsområdets dev-script på port {{port}}. Tilføj @opencode-ai/preview/vite til din Vite-konfiguration for at aktivere kildeinspektion.",
  "session.preview.directory": "Projektmappe",
  "session.preview.port": "Port",
  "session.preview.start": "Start forhåndsvisning",
  "session.preview.restart": "Genstart forhåndsvisning",
  "session.preview.serverUnreachable": "Forhåndsvisningsserveren blev ikke tilgængelig på {{url}}",
  "session.preview.processExited": "Forhåndsvisningsprocessen afsluttede med koden {{code}}",
