export const dict = {
  ...
  "command.preview.description": "Voer de React-app van de werkruimte uit en inspecteer deze",
  ...
  "session.tab.preview": "Voorbeeld",
  "session.tab.unknown": "Onbekende sessie",
  "session.preview.locatorUnavailable": "Locator niet beschikbaar",
  "session.preview.sourceOutsideWorkspace": "Voorbeeldbron bevindt zich buiten de actieve werkruimte",
  "session.preview.inspectorError": "Fout in voorbeeldinspectie",
  "session.preview.inspect": "Inspecteren",
  "session.preview.reload": "Opnieuw laden",
  "session.preview.logs": "Logboeken",
  "session.preview.heading": "Voorbeeld van je React-app",
  "session.preview.starting": "Voorbeeld starten...",
  "session.preview.description":
    "Voert het dev-script van de werkruimte uit op poort {{port}}. Voeg @opencode-ai/preview/vite toe aan je Vite-configuratie om broninspectie in te schakelen.",
  "session.preview.directory": "Projectmap",
  "session.preview.port": "Poort",
  "session.preview.start": "Voorbeeld starten",
  "session.preview.restart": "Voorbeeld opnieuw starten",
  "session.preview.serverUnreachable": "Voorbeeldserver is niet bereikbaar geworden op {{url}}",
  "session.preview.processExited": "Voorbeeldproces afgesloten met code {{code}}",
