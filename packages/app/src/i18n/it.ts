export const dict = {
  ...
  "command.preview.description": "Esegui e ispeziona l'app React dell'area di lavoro",
  ...
  "session.tab.preview": "Anteprima",
  "session.tab.unknown": "Sessione sconosciuta",
  "session.preview.locatorUnavailable": "Localizzatore non disponibile",
  "session.preview.sourceOutsideWorkspace": "L'origine dell'anteprima è esterna all'area di lavoro attiva",
  "session.preview.inspectorError": "Errore dell'ispettore dell'anteprima",
  "session.preview.inspect": "Ispeziona",
  "session.preview.reload": "Ricarica",
  "session.preview.logs": "Log",
  "session.preview.heading": "Visualizza l'anteprima della tua app React",
  "session.preview.starting": "Avvio dell'anteprima...",
  "session.preview.description":
    "Esegue lo script dev dell'area di lavoro sulla porta {{port}}. Aggiungi @opencode-ai/preview/vite alla configurazione di Vite per abilitare l'ispezione del codice sorgente.",
  "session.preview.directory": "Cartella del progetto",
  "session.preview.port": "Porta",
  "session.preview.start": "Avvia l'anteprima",
  "session.preview.restart": "Riavvia l'anteprima",
  "session.preview.serverUnreachable": "Il server di anteprima non è diventato raggiungibile a {{url}}",
  "session.preview.processExited": "Il processo di anteprima è terminato con codice {{code}}",
