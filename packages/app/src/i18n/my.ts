export const dict = {
  ...
  "command.preview.description": "အလုပ်နေရာ React အက်ပ်ကို ဖွင့်ပြီး စစ်ဆေးပါ။",
  ...
  "session.tab.preview": "အကြိုကြည့်ရှုခြင်း",
  "session.tab.unknown": "အမည်မသိ ဆက်ရှင်",
  "session.preview.locatorUnavailable": "တည်နေရာညွှန်း မရနိုင်ပါ။",
  "session.preview.sourceOutsideWorkspace": "အကြိုကြည့်ရှုမှု ရင်းမြစ်သည် လက်ရှိအလုပ်နေရာအပြင်ဘက်တွင် ရှိသည်။",
  "session.preview.inspectorError": "အကြိုကြည့်ရှုမှု စစ်ဆေးရေး အမှား",
  "session.preview.inspect": "စစ်ဆေးပါ။",
  "session.preview.reload": "ပြန်လည်စတင်ပါ။",
  "session.preview.logs": "မှတ်တမ်းများ",
  "session.preview.heading": "သင့် React အက်ပ်ကို အကြိုကြည့်ပါ။",
  "session.preview.starting": "အကြိုကြည့်ရှုမှု စတင်နေသည်...",
  "session.preview.description":
    "အလုပ်နေရာ dev script ကို ဆိပ်ကမ်း {{port}} တွင် ဖွင့်သည်။ ရင်းမြစ်စစ်ဆေးမှုကို ဖွင့်ရန် သင့် Vite config တွင် @opencode-ai/preview/vite ကို ထည့်ပါ။",
  "session.preview.directory": "ပရောဂျက် လမ်းညွှန်",
  "session.preview.port": "ဆိပ်ကမ်း",
  "session.preview.start": "အကြိုကြည့်ရှုမှုကို စတင်ပါ။",
  "session.preview.restart": "အကြိုကြည့်ရှုမှုကို ပြန်လည်စတင်ပါ။",
  "session.preview.serverUnreachable": "အကြိုကြည့်ရှုမှု ဆာဗာသည် {{url}} တွင် ဆက်သွယ်၍မရခဲ့ပါ။",
  "session.preview.processExited": "အကြိုကြည့်ရှုမှု လုပ်ငန်းစဉ်သည် ကုဒ် {{code}} ဖြင့် ထွက်ခဲ့သည်။",
