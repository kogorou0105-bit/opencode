export const dict = {
  ...
  "command.preview.description": "Spusťte a zkontrolujte React aplikaci v pracovním prostoru",
  ...
  "session.tab.preview": "Náhled",
  "session.tab.unknown": "Neznámá relace",
  "session.preview.locatorUnavailable": "Lokátor není k dispozici",
  "session.preview.sourceOutsideWorkspace": "Zdroj náhledu je mimo aktivní pracovní prostor",
  "session.preview.inspectorError": "Chyba inspektora náhledu",
  "session.preview.inspect": "Zkontrolovat",
  "session.preview.reload": "Znovu načíst",
  "session.preview.logs": "Protokoly",
  "session.preview.heading": "Náhled React aplikace",
  "session.preview.starting": "Spouštění náhledu...",
  "session.preview.description":
    "Spustí vývojový skript pracovního prostoru na portu {{port}}. Přidejte @opencode-ai/preview/vite do konfigurace Vite pro povolení kontroly zdroje.",
  "session.preview.directory": "Adresář projektu",
  "session.preview.port": "Port",
  "session.preview.start": "Spustit náhled",
  "session.preview.restart": "Restartovat náhled",
  "session.preview.serverUnreachable": "Server náhledu nebyl dostupný na {{url}}",
  "session.preview.processExited": "Proces náhledu skončil s kódem {{code}}",
