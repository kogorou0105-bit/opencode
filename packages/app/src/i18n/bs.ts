export const dict = {
  ...
  "session.preview.locatorUnavailable": "Lokator nije dostupan",
  "session.preview.sourceOutsideWorkspace": "Izvor pregleda je izvan aktivnog radnog prostora",
  "session.preview.inspectorError": "Greška inspektora pregleda",
  "session.preview.inspect": "Pregledaj",
  "session.preview.reload": "Ponovo učitaj",
  "session.preview.logs": "Zapisnici",
  "session.preview.heading": "Pregledaj svoju React aplikaciju",
  "session.preview.starting": "Pokretanje pregleda...",
  "session.preview.description":
    "Pokreće dev skriptu radnog prostora na portu {{port}}. Dodaj @opencode-ai/preview/vite u svoju Vite konfiguraciju da omogućiš inspekciju izvora.",
  "session.preview.directory": "Direktorij projekta",
  "session.preview.port": "Port",
  "session.preview.start": "Pokreni pregled",
  "session.preview.restart": "Ponovo pokreni pregled",
  "session.preview.serverUnreachable": "Server za pregled nije postao dostupan na {{url}}",
  "session.preview.processExited": "Proces pregleda je završio s kodom {{code}}",
