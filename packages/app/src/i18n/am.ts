export const dict = {
  ...
  "command.preview.description": "የWorkspace React መተግበሪያውን ያሂዱ እና ይመርምሩ",
  ...
  "session.tab.preview": "ቅድመ እይታ",
  "session.tab.unknown": "ያልታወቀ ክፍለ ጊዜ",
  "session.preview.locatorUnavailable": "Locator አይገኝም",
  "session.preview.sourceOutsideWorkspace": "የቅድመ እይታ ምንጭ ከንቁ Workspace ውጪ ነው",
  "session.preview.inspectorError": "የቅድመ እይታ መመርመሪያ ስህተት",
  "session.preview.inspect": "መርምር",
  "session.preview.reload": "ዳግም ጫን",
  "session.preview.logs": "ምዝግቦች",
  "session.preview.heading": "የእርስዎን React መተግበሪያ ቅድመ እይታ ያድርጉ",
  "session.preview.starting": "ቅድመ እይታ በመጀመር ላይ...",
  "session.preview.description":
    "የWorkspace dev ስክሪፕቱን በፖርት {{port}} ላይ ያሂዳል። የምንጭ ምርመራን ለማንቃት @opencode-ai/preview/vite ን በVite ውቅርዎ ላይ ያክሉ።",
  "session.preview.directory": "የፕሮጀክት ማውጫ",
  "session.preview.port": "ፖርት",
  "session.preview.start": "ቅድመ እይታ ጀምር",
  "session.preview.restart": "ቅድመ እይታ እንደገና አስጀምር",
  "session.preview.serverUnreachable": "የቅድመ እይታ አገልጋይ በ{{url}} ላይ ተደራሽ አልሆነም",
  "session.preview.processExited": "የቅድመ እይታ ሂደት በኮድ {{code}} ወጥቷል",
