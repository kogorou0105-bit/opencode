export const dict = {
  ...
  "command.preview.description": "İş sahəsinin React tətbiqini işə salın və yoxlayın",
  ...
  "session.tab.preview": "Önbaxış",
  "session.tab.unknown": "Naməlum sessiya",
  "session.preview.locatorUnavailable": "Lokator əlçatan deyil",
  "session.preview.sourceOutsideWorkspace": "Önbaxış mənbəyi aktiv iş sahəsindən kənardadır",
  "session.preview.inspectorError": "Önbaxış inspektor xətası",
  "session.preview.inspect": "İncələ",
  "session.preview.reload": "Yenidən yüklə",
  "session.preview.logs": "Jurnallar",
  "session.preview.heading": "React tətbiqinizə önbaxış",
  "session.preview.starting": "Önbaxış başladılır...",
  "session.preview.description":
    "İş sahəsinin dev skriptini {{port}} portunda işlədir. Mənbə yoxlamasını aktivləşdirmək üçün Vite konfiqurasiyanıza @opencode-ai/preview/vite əlavə edin.",
  "session.preview.directory": "Layihə qovluğu",
  "session.preview.port": "Port",
  "session.preview.start": "Önbaxışı başlat",
  "session.preview.restart": "Önbaxışı yenidən başlat",
  "session.preview.serverUnreachable": "Önbaxış serveri {{url}} ünvanında əlçatan olmadı",
  "session.preview.processExited": "Önbaxış prosesi {{code}} kodu ilə dayandı",
