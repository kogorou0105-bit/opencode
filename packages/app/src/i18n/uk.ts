export const dict = {
  ...
  "command.preview.description": "Запустити та перевірити React-застосунок робочої області",
  ...
  "session.tab.preview": "Перегляд",
  "session.tab.unknown": "Невідома сесія",
  "session.preview.locatorUnavailable": "Локатор недоступний",
  "session.preview.sourceOutsideWorkspace": "Джерело перегляду за межами активної робочої області",
  "session.preview.inspectorError": "Помилка інспектора перегляду",
  "session.preview.inspect": "Перевірити",
  "session.preview.reload": "Перезавантажити",
  "session.preview.logs": "Журнали",
  "session.preview.heading": "Перегляньте свій React-застосунок",
  "session.preview.starting": "Запуск перегляду...",
  "session.preview.description":
    "Запускає dev-скрипт робочої області на порті {{port}}. Додайте @opencode-ai/preview/vite до конфігурації Vite, щоб увімкнути перевірку коду.",
  "session.preview.directory": "Каталог проєкту",
  "session.preview.port": "Порт",
  "session.preview.start": "Запустити перегляд",
  "session.preview.restart": "Перезапустити перегляд",
  "session.preview.serverUnreachable": "Сервер перегляду не став доступним за адресою {{url}}",
  "session.preview.processExited": "Процес перегляду завершився з кодом {{code}}",
