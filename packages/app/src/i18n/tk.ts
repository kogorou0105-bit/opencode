export const dict = {
  ...
  "command.preview.description": "Workspace React programmasyny işlediň we gözden geçiriň",
  ...
  "session.tab.preview": "Öňünden görmek",
  "session.tab.unknown": "Näbelli sessiýa",
  "session.preview.locatorUnavailable": "Lokator elýeterli däl",
  "session.preview.sourceOutsideWorkspace": "Öňünden görmek çeşmesi işjeň workspace-iň daşynda",
  "session.preview.inspectorError": "Öňünden görmek inspektorynyň ýalňyşlygy",
  "session.preview.inspect": "Barla",
  "session.preview.reload": "Gaýtadan ýükläň",
  "session.preview.logs": "Surnallar",
  "session.preview.heading": "React programmaňyzy öňünden görüň",
  "session.preview.starting": "Öňünden görmek başlanylýar...",
  "session.preview.description":
    "Workspace dev skriptini {{port}} portunda işledýär. Çeşmäni barlamagy açmak üçin Vite konfigurasiýaňyza @opencode-ai/preview/vite goşuň.",
  "session.preview.directory": "Taslama bukjasy",
  "session.preview.port": "Port",
  "session.preview.start": "Öňünden görmegi başlat",
  "session.preview.restart": "Öňünden görmegi täzeden başlat",
  "session.preview.serverUnreachable": "Öňünden görmek serweri {{url}} salgyda elýeterli bolmady",
  "session.preview.processExited": "Öňünden görmek prosesi {{code}} kod bilen tamamlandy",
