export const dict = {
  ...
  "command.preview.description": "برنامه React فضای کاری را اجرا و بازبینی کنید",
  ...
  "session.tab.preview": "پیش‌نمایش",
  "session.tab.unknown": "جلسه ناشناخته",
  "session.preview.locatorUnavailable": "مکان‌یاب در دسترس نیست",
  "session.preview.sourceOutsideWorkspace": "منبع پیش‌نمایش خارج از فضای کاری فعال است",
  "session.preview.inspectorError": "خطای بازرس پیش‌نمایش",
  "session.preview.inspect": "بازرسی",
  "session.preview.reload": "بارگذاری مجدد",
  "session.preview.logs": "گزارش‌ها",
  "session.preview.heading": "برنامه React خود را پیش‌نمایش کنید",
  "session.preview.starting": "در حال شروع پیش‌نمایش...",
  "session.preview.description":
    "اسکریپت dev فضای کاری را روی پورت {{port}} اجرا می‌کند. برای فعال‌سازی بازرسی منبع، @opencode-ai/preview/vite را به پیکربندی Vite خود اضافه کنید.",
  "session.preview.directory": "دایرکتوری پروژه",
  "session.preview.port": "پورت",
  "session.preview.start": "شروع پیش‌نمایش",
  "session.preview.restart": "راه‌اندازی مجدد پیش‌نمایش",
  "session.preview.serverUnreachable": "سرور پیش‌نمایش در {{url}} در دسترس نشد",
  "session.preview.processExited": "فرایند پیش‌نمایش با کد {{code}} خاتمه یافت",
