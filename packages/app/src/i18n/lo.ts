export const dict = {
  ...
  "command.preview.description": "ແລ່ນ ແລະກວດສອບແອັບ React ຂອງພື້ນທີ່ເຮັດວຽກ",
  ...
  "session.tab.preview": "ຕົວຢ່າງ",
  "session.tab.unknown": "ເຊດຊັນທີ່ບໍ່ຮູ້ຈັກ",
  "session.preview.locatorUnavailable": "Locator ບໍ່ສາມາດໃຊ້ໄດ້",
  "session.preview.sourceOutsideWorkspace": "ແຫຼ່ງທີ່ມາຂອງຕົວຢ່າງຢູ່ນອກພື້ນທີ່ເຮັດວຽກທີ່ໃຊ້ງານຢູ່",
  "session.preview.inspectorError": "ຂໍ້ຜິດພາດຕົວກວດສອບຕົວຢ່າງ",
  "session.preview.inspect": "ກວດສອບ",
  "session.preview.reload": "ໂຫຼດໃໝ່",
  "session.preview.logs": "ບັນທຶກ",
  "session.preview.heading": "ເບິ່ງຕົວຢ່າງແອັບ React ຂອງທ່ານ",
  "session.preview.starting": "ກຳລັງເລີ່ມຕົວຢ່າງ...",
  "session.preview.description":
    "ແລ່ນສະຄຣິບ dev ຂອງພື້ນທີ່ເຮັດວຽກຢູ່ພອດ {{port}}. ເພີ່ມ @opencode-ai/preview/vite ໃສ່ config Vite ຂອງທ່ານເພື່ອເປີດໃຊ້ການກວດສອບແຫຼ່ງທີ່ມາ.",
  "session.preview.directory": "ໄດເລກະທໍລີໂຄງການ",
  "session.preview.port": "ພອດ",
  "session.preview.start": "ເລີ່ມຕົວຢ່າງ",
  "session.preview.restart": "ຣີສະຕາດຕົວຢ່າງ",
  "session.preview.serverUnreachable": "ເຊີບເວີຕົວຢ່າງບໍ່ສາມາດເຂົ້າເຖິງໄດ້ທີ່ {{url}}",
  "session.preview.processExited": "ໂປຣເຊສຕົວຢ່າງອອກດ້ວຍລະຫັດ {{code}}",
