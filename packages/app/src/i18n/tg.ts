export const dict = {
  ...
  "command.preview.description": "Барномаи React-и фазои кориро иҷро ва тафтиш кунед",
  ...
  "session.tab.preview": "Пешнамоиш",
  "session.tab.unknown": "Сеанси номаълум",
  "session.preview.locatorUnavailable": "Локатор дастрас нест",
  "session.preview.sourceOutsideWorkspace": "Манбаи пешнамоиш берун аз фазои кории фаъол аст",
  "session.preview.inspectorError": "Хатогии инспектори пешнамоиш",
  "session.preview.inspect": "Тафтиш",
  "session.preview.reload": "Аз нав бор кунед",
  "session.preview.logs": "Гузоришҳо",
  "session.preview.heading": "Барномаи React-и худро пешнамоиш кунед",
  "session.preview.starting": "Пешнамоиш оғоз мешавад...",
  "session.preview.description":
    "Скрипти dev-и фазои кориро дар порти {{port}} иҷро мекунад. Барои фаъол кардани тафтиши манба @opencode-ai/preview/vite-ро ба конфиги Vite-и худ илова кунед.",
  "session.preview.directory": "Феҳристи лоиҳа",
  "session.preview.port": "Порт",
  "session.preview.start": "Оғози пешнамоиш",
  "session.preview.restart": "Бозоғозии пешнамоиш",
  "session.preview.serverUnreachable": "Сервери пешнамоиш дар {{url}} дастрас нашуд",
  "session.preview.processExited": "Раванди пешнамоиш бо коди {{code}} ба охир расид",
