...
export const dict = {
  ...
  "command.preview.description": "Keyra og skoða React-forrit vinnurýmisins",
  ...
  "session.tab.preview": "Forskoðun",
  "session.tab.unknown": "Óþekkt lota",
  "session.preview.locatorUnavailable": "Staðsetjari ótiltækur",
  "session.preview.sourceOutsideWorkspace": "Forskoðunargjafi er utan virka vinnurýmisins",
  "session.preview.inspectorError": "Villa í forskoðunarskoðara",
  "session.preview.inspect": "Skoða",
  "session.preview.reload": "Endurhlaða",
  "session.preview.logs": "Atvikaskrár",
  "session.preview.heading": "Forskoðaðu React-forritið þitt",
  "session.preview.starting": "Ræsi forskoðun...",
  "session.preview.description":
    "Keyrir þróunarskriftu vinnurýmisins á gátt {{port}}. Bættu @opencode-ai/preview/vite við Vite-stillingarnar til að virkja skoðun frumkóða.",
  "session.preview.directory": "Verkefnismappa",
  "session.preview.port": "Gátt",
  "session.preview.start": "Hefja forskoðun",
  "session.preview.restart": "Endurræsa forskoðun",
  "session.preview.serverUnreachable": "Forskoðunarþjónn varð ekki tiltækur á {{url}}",
  "session.preview.processExited": "Forskoðunarferli lauk með kóða {{code}}",
