export const dict = {
  ...
  "command.preview.description": "Запустить и проверить React-приложение в рабочей области",
  ...
  "session.preview.locatorUnavailable": "Локатор недоступен",
  "session.preview.sourceOutsideWorkspace": "Источник предпросмотра находится вне активного рабочего пространства",
  "session.preview.inspectorError": "Ошибка инспектора предпросмотра",
  "session.preview.inspect": "Проверить",
  "session.preview.reload": "Перезагрузить",
  "session.preview.logs": "Журналы",
  "session.preview.heading": "Предпросмотр React-приложения",
  "session.preview.starting": "Запуск предпросмотра...",
  "session.preview.description":
    "Запускает скрипт разработки рабочей области на порту {{port}}. Добавьте @opencode-ai/preview/vite в конфигурацию Vite, чтобы включить проверку источника.",
  "session.preview.directory": "Каталог проекта",
  "session.preview.port": "Порт",
  "session.preview.start": "Запустить предпросмотр",
  "session.preview.restart": "Перезапустить предпросмотр",
  "session.preview.serverUnreachable": "Сервер предпросмотра не стал доступен по адресу {{url}}",
  "session.preview.processExited": "Процесс предпросмотра завершился с кодом {{code}}",
