...
export const dict = {
  ...
  "command.preview.description": "Pokreni i pregledaj React aplikaciju radnog prostora",
  ...
  "session.tab.preview": "Pretpregled",
  "session.tab.unknown": "Nepoznata sesija",
  "session.preview.locatorUnavailable": "Lokator nedostupan",
  "session.preview.sourceOutsideWorkspace": "Izvor pretpregleda je izvan aktivnog radnog prostora",
  "session.preview.inspectorError": "Pogreška inspektora pretpregleda",
  "session.preview.inspect": "Inspektiraj",
  "session.preview.reload": "Ponovno učitaj",
  "session.preview.logs": "Zapisnici",
  "session.preview.heading": "Pretpregled React aplikacije",
  "session.preview.starting": "Pokretanje pretpregleda...",
  "session.preview.description":
    "Pokreće razvojnu skriptu radnog prostora na priključku {{port}}. Dodaj @opencode-ai/preview/vite u svoju Vite konfiguraciju kako bi se omogućila inspekcija izvora.",
  "session.preview.directory": "Direktorij projekta",
  "session.preview.port": "Priključak",
  "session.preview.start": "Pokreni pretpregled",
  "session.preview.restart": "Ponovno pokreni pretpregled",
  "session.preview.serverUnreachable": "Poslužitelj pretpregleda nije postao dostupan na {{url}}",
  "session.preview.processExited": "Proces pretpregleda završio je s kodom {{code}}",
